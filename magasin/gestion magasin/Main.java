...
public class Main {
    public static void main(String[] args) {
        ...
        Caisser caissier1 = new Caisser(1, "ala", "Adresse1", 160, 1);
        Caisser caissier12 = new Caisser(1, "ala", "Adresse1", 160, 2);
        ...
        Caisser caissier2 = new Caisser(1, "ala", "Adresse1", 160, 3);
